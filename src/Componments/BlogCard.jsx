...
function BlogCard({data}) {
    ...
    return (
        <>
            ...
            >
                <Link
                to={`/blog/${data?.slug}`}  className="blog-card flex flex-col gap-2 border border-gray bg-white rounded-t-2xl group hover:border-accent rounded-b-2xl col-span-2 lg:col-span-1 hover:-translate-y-1 h-full">
