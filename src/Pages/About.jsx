            ...
            <section className="py-10 bg-primary/5 relative bg-[url('/assets/images/particles-bg.png')] bg-center bg-cover mt-20 xl:mt-20 2xl:mt-25">
                <div className="container px-2 lg:px-5 mx-auto z-1">
                    <div className="text-center content-center min-h-45 max-w-full mx-auto md:min-h-50 md:max-w-9/10 lg:max-w-2/3 lg:min-h-50 xl:min-h-75 2xl:min-h-100">
                        <h1 className="text-[36px] text-secondary font-black md:text-[54px] 2xl:text-[70px]"> <span className="text-primary">About</span> Our Company</h1>
            ...
            <section className="py-10 bg-linear-to-l from-[#1F4567] to-secondary overflow-hidden md:py-18 lg:py-15 xl:py-16 2xl:py-22">
                <div className="container px-2 lg:px-5 mx-auto relative z-1">
                    ...
                    <div className="text-center relative z-1">
                        <h2 className="text-[40px] text-white font-bold mb-2 md:mb-4 md:text-[50px]">Our <span className="text-primary">Vission</span></h2>
                        <p className="text-lg font-commissioner leading-8.5 text-white/90 md:leading-9 lg:text-lg lg:leading-8 2xl:text-xl 2xl:leading-9">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. </p>
                    </div>
                </div>
            </section>
