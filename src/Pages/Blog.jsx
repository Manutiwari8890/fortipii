...
function Blog(){
    return (
        <>
            ...
            <section className="py-20 xl:pt-15 xl:pb-5 2xl:py-20">
                <div className="container px-2 lg:px-5 mx-auto z-1">
                    <div className="grid grid-cols-3 gap-10">
                        <div className="grid grid-cols-2 col-span-3 gap-10 group">
                            <div className="img-container overflow-hidden bg-[#F5FDF9] rounded-3xl min-h-100 xl:min-h-85 2xl:min-h-100">
                            ...
                            <div className="text-left h-full content-center">
                                <p className="text-lg font-commissioner font-medium text-primary mb-5 xl:text-base lg:mb-3 2xl:text-lg 2xl:mb-5">Built for Small Offices</p>
                                <Link className="text-[40px] text-secondary leading-[46px] font-bold hover:text-[#2e988b] xl:text-[32px] xl:leading-[38px] 2xl:text-[40px] 2xl:leading-[46px]">It is a long established fact that a reader will be distracted by the readable.</Link>
                                <div className="flex gap-3 items-center mt-8 mb-5 xl:mt-6 xl:mb-3 2xl:mt-8 2xl:mb-5">
                                    <p className="text-xl text-[#838B9C] font-commissioner xl:text-lg 2xl:text-xl">by <span className="text-primary">John Doe</span></p>
                                    <span className="inline-block bg-[#BEC3CE] w-3 h-3 rounded-full  xl:w-2 xl:h-2 2xl:w-3 2xl:h-3"></span>
                                    <p className="text-xl text-[#838B9C] font-commissioner xl:text-lg 2xl:text-xl">June 19, 2025</p>
                                </div>
                                <p className="text-xl text-[#4B5563] font-commissioner 2xl:text-xl xl:text-lg">Donec pede justo fringilla vel aliquet nec vulputate eget arcu. In enim justo rhoncus ut imperdiet a venenatis vitae justo….</p>
                            </div>
                        </div>
                    ...
                    <div className="py-8 flex gap-5 justify-center items-center xl:gap-3 2xl:gap-5">
                        <button className="w-15 h-15 text-center content-center rounded-full text-primary/30 bg-primary/10 cursor-not-allowed xl:w-12 xl:h-12 2xl:w-15 2xl:h-15">
                        ...
                        <button className="w-15 h-15 text-center text-lg font-commissioner font-semibold content-center rounded-full cursor-pointer text-white bg-primary xl:w-12 xl:h-12 2xl:w-15 2xl:h-15">
                            1
                        </button>
                        <button className="w-15 h-15 text-center text-lg font-commissioner font-semibold content-center rounded-full cursor-pointer text-primary bg-primary/10 hover:text-white hover:bg-primary xl:w-12 xl:h-12 2xl:w-15 2xl:h-15">
                            2
                        </button>
                        <button className="w-15 h-15 text-center text-lg font-commissioner font-semibold content-center rounded-full cursor-pointer text-primary bg-primary/10 hover:text-white hover:bg-primary xl:w-12 xl:h-12 2xl:w-15 2xl:h-15">
                            3
                        </button>
                        <button className="w-15 h-15 text-center content-center rounded-full cursor-pointer text-primary bg-primary/10 hover:text-white hover:bg-primary xl:w-12 xl:h-12 2xl:w-15 2xl:h-15">
                            <svg width="18" height="17" viewBox="0 0 18 17" fill="none" className="mx-auto" xmlns="http://www.w3.org/2000/svg">
