                    ...
                    <div className="content-center md:min-h-[54vh] lg:min-h-[64vh] 2xl:min-h-[55vh]">
                        <div className="shadow-sm mx-auto max-w-[500px] px-10 py-10 mt-15 rounded-4xl">
                            ...
                            <form>
                                ...
                                <button className="btn-primary bg-secondary w-full font-commissioner text-lg relative font-medium text-white py-4 px-8 rounded-full cursor-pointer mx-auto">Login</button>
                            </form>
                        </div>
                    </div>
