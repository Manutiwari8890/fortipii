        ...
        <>
            <section className="py-10 bg-primary/5 relative bg-[url('/assets/images/particles-bg.png')] bg-center bg-cover mt-20 xl:mt-20 2xl:mt-25">
                <div className="container px-2 lg:px-5 mx-auto z-1">
                    <div className="text-center content-center min-h-100 max-w-1/2 mx-auto xl:min-h-75 2xl:min-h-100">
                        <h1 className="text-[70px] text-secondary font-black xl:text-[54px] 2xl:text-[70px]">Risk <span className="text-primary">Assessment</span></h1>
                        <p className="text-xl text-[#4B5563] leading-8 mt-2 font-commissioner xl:text-lg xl:leading-7 2xl:text-xl 2xl:leading-8">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
                    </div>
                </div>
            </section>
            <section className="py-20 bg-linear-to-l from-[#1F4567] to-secondary xl:py-15 2xl:py-20">
                <div className="container px-2 lg:px-5 mx-auto z-1">
                    <div className="text-center">
                        <h2 className="text-[50px] text-white font-bold mb-4 xl:text-[40px] xl:mb-2 2xl:text-[50px] 2xl:mb-4">Intelligent Data Privacy Advisor</h2>
                        <p className="text-xl font-commissioner text-white xl:text-lg 2xl:text-xl">Assess your PLL exposure and get personalized recommendations</p>
                    </div>
                    <div className="relative mt-20 xl:mt-10 2xl:mt-20">
                        <div className="absolute bg-[#396288] w-[85%] h-3 bottom-20 left-1/2 -translate-x-1/2 z-0"></div>
                        <div className="grid grid-cols-7 relative z-1">
                            <div className="p-2 text-center content-center">
                                <div className={`text-white font-commissioner w-20 h-20 mx-auto content-center rounded-full ${step==1 ? "bg-primary " :  "bg-[#3A5D7F]"} text-3xl font-semibold mb-4`}>1</div>
                                <p className="text-xl text-white xl:text-lg 2xl:text-xl">Welcome</p>
                            </div>
                            <div className="p-2 text-center content-center">
                                <div className={`text-white font-commissioner w-20 h-20 mx-auto content-center rounded-full ${step==2 ? "bg-primary " :  "bg-[#3A5D7F]"} text-3xl font-semibold mb-4`}>2</div>
                                <p className="text-xl text-white xl:text-lg 2xl:text-xl">Environment</p>
                            </div>
                            <div className="p-2 text-center content-center">
                                <div className={`text-white font-commissioner w-20 h-20 mx-auto content-center rounded-full ${step==3 ? "bg-primary " :  "bg-[#3A5D7F]"} text-3xl font-semibold mb-4`}>3</div>
                                <p className="text-xl text-white xl:text-lg 2xl:text-xl">Locations</p>
                            </div>
                            <div className="p-2 text-center content-center">
                                <div className={`text-white font-commissioner w-20 h-20 mx-auto content-center rounded-full ${step==4 ? "bg-primary " :  "bg-[#3A5D7F]"} text-3xl font-semibold mb-4`}>4</div>
                                <p className="text-xl text-white xl:text-lg 2xl:text-xl">Email</p>
                            </div>
                            <div className="p-2 text-center content-center">
                                <div className={`text-white font-commissioner w-20 h-20 mx-auto content-center rounded-full ${step==5 ? "bg-primary " :  "bg-[#3A5D7F]"} text-3xl font-semibold mb-4`}>5</div>
                                <p className="text-xl text-white xl:text-lg 2xl:text-xl">Scanning</p>
                            </div>
                            <div className="p-2 text-center content-center">
                                <div className={`text-white font-commissioner w-20 h-20 mx-auto content-center rounded-full ${step==6 ? "bg-primary " :  "bg-[#3A5D7F]"} text-3xl font-semibold mb-4`}>6</div>
                                <p className="text-xl text-white xl:text-lg 2xl:text-xl">Results</p>
                            </div>
                            <div className="p-2 text-center content-center">
                                <div className={`text-white font-commissioner w-20 h-20 mx-auto content-center rounded-full ${step==7 ? "bg-primary " :  "bg-[#3A5D7F]"} text-3xl font-semibold mb-4`}>7</div>
                                <p className="text-xl text-white xl:text-lg 2xl:text-xl">Welcome</p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 xl:py-15 2xl:py-20">
                <div className="container px-2 lg:px-5 mx-auto z-1">
            ...
            <section className="py-20 bg-linear-to-l from-[#1F4567] to-secondary xl:py-15 2xl:py-20">
                <div className="container px-2 lg:px-5 mx-auto z-1">
                    <div className="text-center w-2/3 mx-auto mb-10">
                        <h3 className="text-lg font-commissioner font-medium text-primary mb-2 xl:mb-1 2xl:mb-2">PRICING</h3>
                        <h2 className="text-[50px] text-white font-bold mb-4 xl:text-[40px] xl:mb-2 2xl:text-[50px] 2xl:mb-4">Choose your Fortipii plan</h2>
                        <p className="text-xl font-commissioner text-white font-normal xl:text-lg 2xl:text-xl">Start with a simple trial, then move into Shield, Guardian, or Fortress as your scanning, redaction, and email protection needs grow. Final pricing can be tuned for number of seats and locations.</p>
                    </div>
                    <div className="grid grid-cols-4 gap-4">
                        <div className="border border-[#0000001A] bg-white rounded-3xl overflow-hidden hover:border-[#5ED1C0] hover:bg-[#E8FAF2]">
            ...
            <section className="xl:py-10 2xl:py-20">
                <div className="container px-2 lg:px-5 mx-auto z-1">
                    <div className="title-wrapper text-center max-w-2/3 mx-auto mb-15 xl:max-w-2/3 2xl:max-w-1/2">
                        <h2 className="text-[50px] font-extrabold text-secondary leading-14 mb-4">Frequently Asked Questions</h2>
                        <p className="text-xl font-commissioner text-[#4B5563] font-normal max-w-[90%] mx-auto xl:text-lg 2xl:text-xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua utenim ad minim veniam.</p>
                    </div>
                    <div className="max-w-2/3 px-20 py-15 bg-white shadow-sm mx-auto mt-15 rounded-[60px] xl:max-w-3/4 xl:px-15 xl:py-10 2xl:max-w-2/3 2xl:px-20 2xl:py-15">
                        <div className={`border-b ${openFaq === 0 ? "border-primary" : "border-[#04396B]"} mb-4`}>
                            <button className="text-2xl text-secondary font-semibold cursor-pointer w-full py-4 text-left flex justify-between hover:text-primary xl:text-xl xl:py-2 2xl:text-2xl 2xl:py-4" onClick={() => setOpenFaq(0)}>
                                Where can I get some?
                                {openFaq === 0 ? 
                                    <svg className="xl:w-4 xl:h-4 2xl:w-5 2xlh-5" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg className="xl:w-4 xl:h-4 2xl:w-5 2xlh-5" viewBox="0 0 25 25" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className={`${openFaq === 0 ? "max-h-max pt-2 pb-4" : "max-h-0"} overflow-hidden transition-300`}>
                                <p className="text-xl text-[#4B5563] font-commissioner leading-8 xl:text-lg xl:leading-7 2xl:text-xl 2xl:leading-8">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                            </div>
                        </div>
                        <div className={`border-b ${openFaq === 1 ? "border-primary" : "border-[#04396B]"} mb-4`}>
                            <button className="text-2xl text-secondary font-semibold cursor-pointer w-full py-4 text-left flex justify-between hover:text-primary xl:text-xl xl:py-2 2xl:text-2xl 2xl:py-4" onClick={() => setOpenFaq(1)}>
                        ...
                        <div className={`border-b ${openFaq === 2 ? "border-primary" : "border-[#04396B]"} mb-4`}>
                            <button className="text-2xl text-secondary font-semibold cursor-pointer w-full py-4 text-left flex justify-between hover:text-primary xl:text-xl xl:py-2 2xl:text-2xl 2xl:py-4" onClick={() => setOpenFaq(2)}>
                                Where can I get some?
                                {openFaq === 2 ? 
                                    <svg className="xl:w-4 xl:h-4 2xl:w-5 2xlh-5" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_96_233)">
                        ...
                        <div className={` ${openFaq === 3 ? "border-primary" : "border-[#04396B]"} mb-4`}>
                            <button className="text-2xl text-secondary font-semibold cursor-pointer w-full py-4 text-left flex justify-between hover:text-primary xl:text-xl xl:py-2 2xl:text-2xl 2xl:py-4" onClick={() => setOpenFaq(3)}>
                                Where does it come from?
                                {openFaq === 3 ? 
                                    <svg className="xl:w-4 xl:h-4 2xl:w-5 2xlh-5" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_96_233)">
